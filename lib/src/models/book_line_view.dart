                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text(book.name.length > 25? book.name.substring(0, 23) + '...': book.name, style: getBookLineNameTextStyle(),),
                            Text(book.author == 'nan'? 'Не указан': book.author, style: getBookLineAuthorTextStyle()),
                          ],
                        ),
                        Row(
                          children: <Widget>[
